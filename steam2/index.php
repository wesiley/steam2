...
<body>
    ...
    <div>
        <nav class="navbar navbar-expand-sm navbar-dark"
            style="background: rgb(11,1,34);background: radial-gradient(circle, rgba(11,1,34,1) 0%, rgba(44,17,78,1) 100%);"
            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse" id="navbarsExample03">
                    ...
                    <div id="divBusca" class="">
                        ...
                        <!--<img src="assets/search.png" id="btnBusca" alt="Buscar" class="" />-->
                    </div>
                </div>
            </div>
        </nav>
    ...
    <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4" id="footer">
        <div class="col-md-4 d-flex align-items-center">
            ...
            <span class="text-muted">@RESERVED RIGHTS STEAM 2</span>
        </div>
